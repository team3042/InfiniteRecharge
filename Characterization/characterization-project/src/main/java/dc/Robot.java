...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonSRX leftMotor = setupWPI_TalonSRX(19, Sides.LEFT, false);

    WPI_TalonSRX leftFollowerID2 = setupWPI_TalonSRX(2, Sides.FOLLOWER, false);
    leftFollowerID2.follow(leftMotor);

    WPI_TalonSRX rightMotor = setupWPI_TalonSRX(17, Sides.RIGHT, false);
    WPI_TalonSRX rightFollowerID15 = setupWPI_TalonSRX(15, Sides.FOLLOWER, false);    
