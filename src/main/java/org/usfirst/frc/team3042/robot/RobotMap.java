...
public class RobotMap {	
	...
	public static final double TRACK_WIDTH_METERS = 0.0; // Calculated width of the robot in meters; this value should be used instead of the real-world robot width! // TODO: Use the Robot Characterization Tool to calculate this value for Phoenix
