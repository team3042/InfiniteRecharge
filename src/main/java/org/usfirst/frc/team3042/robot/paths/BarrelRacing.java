...
public class BarrelRacing implements PathContainer {
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(4.0,-10.0), Rotation2d.fromDegrees(180.0)); 
    }
