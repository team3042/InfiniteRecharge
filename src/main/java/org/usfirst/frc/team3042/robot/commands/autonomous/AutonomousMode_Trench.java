...
public class AutonomousMode_Trench extends CommandGroup {
  ...
  public AutonomousMode_Trench() {
    ...
    addSequential(new Shoot(3)); //Shoot the 3 pre-loaded power cells; Parameter is time in seconds
    ...
    addSequential(new Drivetrain_GyroStraight(220, 120)); // Drive into the trench to collect 3 power cells
    addSequential(new Intake_Intake(0)); //Stop running the intake
    
    addSequential(new Drivetrain_GyroStraight(80, -120));  // Drive closer to the power port before shooting 
